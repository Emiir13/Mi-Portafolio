function App() {
  ...
  return (
    <div style={{
      ...
      <section>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '0.5rem', textAlign: 'center' }}>¡Hola! Soy Emir</h1>
      ...
      <section style={{ marginTop: '3rem' }}>
        <h2 style={{ fontSize: '2rem', textAlign: 'center' }}>Proyectos</h2>
      ...
      <section style={{ marginTop: '3rem' }}>
        <h2 style={{ fontSize: '2rem', textAlign: 'center' }}>Sobre mí</h2>
      ...
      <section style={{ marginTop: '3rem' }}>
        <h2 style={{ fontSize: '2rem', textAlign: 'center' }}>Contacto</h2>
        <form action="https://formspree.io/f/xanorenb" method="POST" style={{
          display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '500px', margin: '0 auto'
        }}>
          <input type="text" name="name" placeholder="Tu nombre" required style={{
            padding: '0.5rem', borderRadius: '6px', border: 'none', backgroundColor: '#2a2a2a', color: '#f0f0f0'
          }} />
          <input type="email" name="email" placeholder="Tu correo" required style={{
            padding: '0.5rem', borderRadius: '6px', border: 'none', backgroundColor: '#2a2a2a', color: '#f0f0f0'
          }} />
          <textarea name="message" placeholder="Tu mensaje" rows="4" required style={{
            padding: '0.5rem', borderRadius: '6px', border: 'none', backgroundColor: '#2a2a2a', color: '#f0f0f0'
          }} />
          <button type="submit" style={{
            padding: '0.6rem', backgroundColor: '#4ea8de', border: 'none', borderRadius: '6px', cursor: 'pointer', color: '#fff'
          }}>Enviar</button>
        </form>
      </section>
    </div>
